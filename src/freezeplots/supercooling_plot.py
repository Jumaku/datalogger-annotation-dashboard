...
MODULE_VERSION = "2026-07-29-y-range-bold-label"
...
def combined(
    ...
    Use None to include all channels from an experiment.
...
def load_supercooling_data(
    input_path: str | Path,
    temperature_column: str = "start_temp_c",
) -> pd.DataFrame:
    """
    Read the cooling-event CSV file and standardize its columns.

    The input file may have a .txt extension as long as its
